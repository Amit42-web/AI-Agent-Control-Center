...
import { Check, FileText, BarChart3, Wrench, FolderOpen, Save, TrendingUp } from 'lucide-react';
...
export function StepNavigator() {
  const { currentStep, goToStep, results, fixes, enhancedFixes, scenarioResults, saveAnalysis, currentAnalysisName } = useAppStore();
